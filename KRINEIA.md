# KRINEIA.md — founder-mode-showcase

**krineia_manifest_version:** 0.1
**schema:** krineia-manifest@0.1

This is the repo-local KRINEIA manifest for `hummbl-dev/founder-mode-showcase`. It declares how this repo participates in KRINEIA governance.
...
repo:
  full_name: "hummbl-dev/founder-mode-showcase"
  default_branch: "main"
  visibility: "public"
...
chains:
  primary:
    chain_id: "founder-mode-showcase-primary"
